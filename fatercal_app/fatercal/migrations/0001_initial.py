# Generated by Django 2.2 on 2019-09-03 22:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cd_taxsup', models.IntegerField(blank=True, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilisateur', models.CharField(max_length=2500, null=True)),
                ('last_update', models.DateField(null=True)),
                ('source', models.CharField(max_length=2500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lb_nom', models.CharField(max_length=250, verbose_name='Nom')),
                ('lb_auteur', models.CharField(blank=True, max_length=250, null=True, verbose_name='Auteur')),
                ('nom_complet', models.CharField(blank=True, max_length=650, null=True)),
                ('habitat', models.SmallIntegerField(null=True)),
                ('nc', models.CharField(blank=True, max_length=4, null=True)),
                ('date', models.DateTimeField(auto_now=False)),
                ('taxrefversion', models.CharField(max_length=250, verbose_name='Nom')),
                ('taxon_id', models.ForeignKey(db_column='taxon_id', on_delete=django.db.models.deletion.DO_NOTHING, to='fatercal.Taxon', verbose_name='Taxon', null=True)),
            ],
            options={
